...
"\x1b[0;91m"    __  ________  ______

"\x1b[0;97m"  /  |/  /  _/ |/ /  _/   • CODE BY Sanzz •
"\x1b[0;92m" / /|_/ // //    // / • HTTPS://GITHUB.COM/BocilAlok •
"\x1b[0;95m"/_/  /_/___/_/|_/___/
'''
def _my_logo_():
    ...
    for _suci_salsabila_ in _cici_.split(" "):
        if len(_suci_salsabila_)<3:
            ...
            if len(_suci_salsabila_)==3 or len(_suci_salsabila_)==4 or len(_suci_salsabila_)==5:
                ...
                _dapunta_.append(_suci_salsabila_+" jelek")
                _dapunta_.append(_suci_salsabila_+" cantik")
...
class _crack_dev_:
    ...
    def api(self,_files_crack_):
        ...
        _dapunta_cici_ ' \033[0;36m[\033[0;35m+\033[0;36m]\033[0;33m Terdapat\033[0;00m ' + str(len(proo)) + '\033[0;33m Opsi'
        for opt in range(len(proo)):
            _dapunta_cici_ '  \033[0;33m[\033[0;35m' + str(opt + 1) + '\033[0;33m]\033[0;36m ' + proo[opt]
                else:continue
